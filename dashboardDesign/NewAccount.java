...
public class NewAccount extends JFrame 
{
    ...
    public void gui ()
    {
       ...
       Color color1 = new Color(135,206,235);//Create a color for Background.
       textField1.setBackground(color1);
       passwordField1.setBackground(color1);
       passwordField2.setBackground(color1);
       Color color2 = new Color(12,10,150);//Create a color for Forground.
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(textField1.getText().isEmpty() || passwordField1.getText().isEmpty() || passwordField2.getText().isEmpty()){
                    ...
                    try{
                        ...
                        Conn con = new Conn(); 
                        String sql = "select max(sn) from newaccount";
                        ...
                        String uid="LB"+count;
                        String submit = "INSERT INTO `newaccount`(`Name`, `Password`,`user_id`) VALUES (?,?,?)";
                        //con = DriverManager.getConnection("jdbc:mysql://localhost:3307/librarian","root","");
                        
                        pst = con.c.prepareStatement(submit);
